...
sinav_notu INT
  ...
  INSERT INTO ogrenciler VALUES(123, 'Ali Can', 'Ankara',75);
    ...
    INSERT INTO ogrenciler VALUES(126, 'Ferhat ÇETİNER', 'Konya',80);
...
/* ========================================================================== */
    ...
    INSERT INTO kelimeler VALUES (1015, 'HOOOOOOT', 3);
...
select * from kelimeler where regexp_like(kelime, 'at|ot');   
 ...
 -----------------------------------------------------------------------------*/   
    ...
    select * from kelimeler where regexp_like(kelime,'^ho|3hi');
...
select * from kelimeler where kelime like 'h_t';-- case sensitive yapamıyoruz bu yöntemle

/* -----------------------------------------------------------------------------
  ORNEK27: İlk harfi h, son harfi t olup 2.harfi a veya i olan 3 harfli 
  kelimelerin tüm bilgilerini sorgulayalım.
 -----------------------------------------------------------------------------*/ 
   select * from kelimeler where regexp_like(kelime, 'h[ai]t'); -- koseli parantez içerisinde veya işaretine gerek yok
