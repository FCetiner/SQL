...
--    SELECT * FROM ogrenciler; -- yorumda da olsa seçerek run yapabiliyoruz
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/     
   delete from ogrenciler; -- ogrenciler tablosua dokunma içeriği sil anlamında
...
==============================================================================*/ 
    ...
    INSERT INTO ogrenciler VALUES(126, 'Nesibe Yilmaz', 'Ayse',95);
    INSERT INTO ogrenciler VALUES(127, 'Mustafa Bak', 'Can',99);
    savepoint abc; -- silindiğinde geri getirmek için bu komutu ekliyoruz her eklemek istediğimizde bu komutu eklememiz gerekir
